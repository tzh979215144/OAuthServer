	...
	a.fn.bsgrid_paging = {
		...
		createPagingToolbar : function(b) {
			...
			if (b.settings.pagingMinWidth != "auto") {
				e.append(' style="width: ' + b.settings.pagingMinWidth
						+ ' !important"')
			}
			e.append(">");
			e.append("<tr>");
			...
			e.append("<td>");
			if (f.first) {
				e.append('<input class="' + d
						+ ' firstPage" type="button" id="' + b.firstPageId
						+ '" value="'
			...
			if (f.refresh) {
				...
				e.append('<input class="' + d
						+ ' refreshPage" type="button" id="' + b.refreshPageId
						+ '" value="'
	...
	$.fn.bsgrid = {
		...
		loadGridData : function(dataType, gridData, options) {
			...
			if (parseSuccess) {
				...
				if (!options.settings.showPageToolbar
						|| (options.settings.displayPagingToolbarOnlyMultiPages && totalPages <= 1)) {
					$("#" + options.pagingId).hide();
					$("#" + options.pagingOutTabId).hide()
				} else {
					...
					$.fn.bsgrid
							...
							.each(
									function(i) {
										...
										$.fn.bsgrid.storeRowData(i, record,
												options);
